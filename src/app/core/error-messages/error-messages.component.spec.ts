...
describe('ErrorMessagesComponent', () => {
  ...
  beforeEach(() => {
    ...
    component.control = new FormControl(null, Validators.compose([Validators.required, Validators.min(1), Validators.max(10)]));
  ...
  it('should show a error', () => {
    expect(fixture.debugElement.nativeElement.querySelectorAll('.form-control-feedback').length).toBe(1);
  });

  it('should show two errors', () => {
    component.control.setErrors([{ required: true }, { min: true }]);
    fixture.detectChanges();
    expect(fixture.debugElement.nativeElement.querySelectorAll('.form-control-feedback').length).toBe(2);
  });

  it('should show three errors', () => {
    component.control.setErrors([{ required: true }, { min: true }, { max: true }]);

    fixture.detectChanges();
    expect(fixture.debugElement.nativeElement.querySelectorAll('.form-control-feedback').length).toBe(3);
  });

  it('should show required error', () => {
    fixture.detectChanges();
    expect(fixture.debugElement.nativeElement.querySelectorAll('#error-0')[0].innerText).toBe('O campo é obrigatório.');
  });
  ...
  it('shouldnt throw error', () => {
    ...
    fixture.detectChanges();
    expect(fixture.nativeElement.querySelectorAll('#error-0')[0]).toBeUndefined();
  });
});
